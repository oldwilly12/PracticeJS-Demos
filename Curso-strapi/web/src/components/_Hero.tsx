...
export const Hero = async () => {
    ...
    return (
        <div className="flex min-h-[70vh] items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-[70vh] w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white dark:bg-black sm:items-start">
